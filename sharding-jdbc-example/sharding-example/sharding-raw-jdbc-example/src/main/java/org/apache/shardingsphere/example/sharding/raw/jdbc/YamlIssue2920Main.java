...
import org.apache.shardingsphere.example.core.jdbc.service.ColumnsService;
...
/*
 */
public class YamlIssue2920Main {
    
    private static ShardingType shardingType = ShardingType.SHARDING_ISSUE_2920;
    ...
    private static ExampleService getExampleService(final DataSource dataSource) {
        return new ColumnsService(dataSource);
    }
